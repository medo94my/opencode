export const dict = {
  ...
  "command.session.toggle.timestamps": "Toggle Timestamps",
  "command.session.toggle.timestamps.description": "Show or hide message timestamps",
  "command.session.toggle.thinking": "Toggle Thinking Blocks",
  "command.session.toggle.thinking.description": "Show or hide reasoning/thinking blocks",
  "command.session.toggle.actions": "Toggle Tool Details",
  "command.session.toggle.actions.description": "Show or hide tool call details",
  "command.session.toggle.conceal": "Toggle Code Concealment",
  "command.session.toggle.conceal.description": "Hide or show code block content",
  "command.session.toggle.generic_tool_output": "Toggle Generic Tool Output",
  "command.session.toggle.generic_tool_output.description": "Show or hide non-file tool output",
  "command.session.toggle.scrollbar": "Toggle Scrollbar",
  "command.session.toggle.scrollbar.description": "Show or hide the session scrollbar",
  "command.session.toggle.diffwrap": "Toggle Diff Wrapping",
  "command.session.toggle.diffwrap.description": "Enable or disable word wrap in diffs",
  "command.session.toggle.animations": "Toggle Animations",
  "command.session.toggle.animations.description": "Enable or disable UI animations",

  "command.session.page.up": "Page Up",
  "command.session.page.up.description": "Scroll up by half page",
  "command.session.page.down": "Page Down",
  "command.session.page.down.description": "Scroll down by half page",
  "command.session.first": "First Message",
  "command.session.first.description": "Scroll to the first message",
  "command.session.last": "Last Message",
  "command.session.last.description": "Scroll to the last message",
  "command.session.lastUser": "Last User Message",
  "command.session.lastUser.description": "Jump to the last user message",

  "command.messages.copy": "Copy Last Assistant Message",
  "command.messages.copy.description": "Copy the last assistant message to clipboard",
  "command.session.copy": "Copy Transcript",
  "command.session.copy.description": "Copy the full session transcript to clipboard",
  "command.session.export": "Export Session",
  "command.session.export.description": "Export session transcript to markdown",
  "command.session.rename": "Rename Session",
  "command.session.rename.description": "Rename the current session",
  "command.session.help": "Help",
  "command.session.help.description": "Show keyboard shortcuts and help",
  "command.session.status": "Status",
  "command.session.status.description": "Show system status overview",
  "command.session.skills": "Skills",
  "command.session.skills.description": "View available skills",
  "command.session.timeline": "Timeline",
  "command.session.timeline.description": "Jump to any message in the session",

  "dialog.export.title": "Export Session",
  "dialog.export.description": "Export session transcript to markdown",
  "dialog.export.filename": "Filename",
  "dialog.export.includeThinking": "Include thinking blocks",
  "dialog.export.includeToolDetails": "Include tool details",
  "dialog.export.includeTimestamps": "Include timestamps",
  "dialog.export.copyToClipboard": "Copy to Clipboard",
  "dialog.export.download": "Download",
  "dialog.export.success": "Exported successfully",
  "dialog.export.copied": "Copied to clipboard",

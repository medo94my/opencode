...
export const SettingsGeneral: Component = () => {
  ...
  return (
    <div class="flex flex-col h-full overflow-y-auto no-scrollbar px-3 pb-10 sm:px-10 sm:pb-10">
...
const SettingsRow: Component<SettingsRowProps> = (props) => {
  return (
    <div class="flex flex-wrap items-center gap-4 py-3 border-b border-border-weak-base last:border-none sm:flex-nowrap">
      <div class="flex min-w-0 flex-1 flex-col gap-0.5 min-w-[120px]">
        <span class="text-14-medium text-text-strong break-words">{props.title}</span>
        <span class="text-12-regular text-text-weak break-words">{props.description}</span>
      </div>
